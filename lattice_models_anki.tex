...
\begin{note}
  ...
  \begin{field}
    For all $S \in \mathcal S$, $\varphi_p(S) \ge P_p(0 \leftrightarrow \infty) > 0$.
  \end{field}
\end{note}
...
\begin{note}
  ...
  \begin{field}
    Assume there is an infinite cluster with probability $1$. Consider the $(2N + 1) \times (2N + 1)$ rhombus $R_N$ centered at the origin and its sides $L_1, L_2, L_3, L_4$. Define $E_i$ the event that $L_i \leftrightarrow \infty$. By Harris, these events are positively correlated, so
